...
YIconLabelButton {
    ...
    icon: "dict/follow-pronunciation-animation-2"
...
//        }
    ...
    SequentialAnimation {
        ...
        PropertyAction {
            ...
            property: "icon"
            value: "dict/follow-pronunciation-animation-0"
        }
        PauseAnimation { duration: iconChangedAnimationDuration }
        PropertyAction {
            target: id_audio_play_icon_label_button
            property: "icon"
            value: "dict/follow-pronunciation-animation-1"
        }
        PauseAnimation { duration: iconChangedAnimationDuration }
        PropertyAction {
            target: id_audio_play_icon_label_button
            property: "icon"
            value: "dict/follow-pronunciation-animation-2"
        }
        PauseAnimation { duration: iconChangedAnimationDuration }
        onRunningChanged: {
            if (!running && ("stop" === id_playing_animation.state)) {
                id_audio_play_icon_label_button.icon = "dict/follow-pronunciation-animation-2"
            }
        }
    }
