    ...
    Item {
        ...
        Column {
            ...
            Item{
                ...
                anchors.right: parent.right
                height:  {
                    return visible ? Math.max(id_number_rectangle.height,id_mean_column.height) : 0
                }
                visible:  {
                   return id_meaning_column.haveMeanText || id_meaning_column.splitWordMeanList.length
                }
...
//                    }
                        ...
                        Column {
                            ...
                            YText {
                                ...
                                text: {
                                    ...
                                    } catch(e) { console.log("YDictTypeDtChXinHuaSpliteMeanComponent.qml===id_extendedMean_mean_text_error,e:"+e) }
                                    textTemp = textTemp.replace(/:/g,"：").replace(/,/g,"，")
                                    return textTemp
                                }
                            }
            ...
            Row{
                ...
                Column {
                    id: id_transformData_colum
                    width: id_word_rectangle_repeater.contentWidth
                    anchors.top: parent.top
                    ...
                    Repeater {
                        ...
                        model:  {
                            ...
                            let temp = []
                            try {
                                temp = id_mean_column.curDataJson["转化"]["分义项"]
                            } catch (e) {
                            }
                            return temp
                        }
                        Item {
                            id: id_transformData_item
                            anchors.left: parent.left
                            anchors.right: parent.right
                            height: id_transformData_text.height + 8
                            visible: id_transformData_repeater.count
                            YText {
                                id: id_transformData_index_text
                                font.family: fontManager.fontFamilyXinHuaXiHei
                                anchors.top: parent.top
                                anchors.left: parent.left
                                font.pixelSize: 26
                                ...
                                visible: text.length
                                onTextChanged: {
                                    visible = Qt.binding(function() {return text.length})
                                }
                                text: (index+1) + '.'
                            }

                            YText {
                                id: id_transformData_text
                                font.family: fontManager.fontFamilyXinHuaXiHei
                                anchors.top: parent.top
                                anchors.left: id_transformData_index_text.right
                                ...
                                text: {
                                    ...
                                    let tempText = ""
                                    try {
                                        tempText =  id_dict_type_ch_ancientword.getMeanRichText((typeof  id_mean_column.curDataJson.转化 !== "undefined"?   id_mean_column.curDataJson.转化.分义项[index].transformMultiMean.replace(/\s*/g,"") : ""))
                                    } catch(e) {
                                    }
