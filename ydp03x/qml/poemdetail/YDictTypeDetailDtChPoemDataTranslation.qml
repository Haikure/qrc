...
YBackButtonPage {
    ...
    objectName: "YPage===YDictTypeDetailDtChPoemDataTranslation.qml"
    ...
    property var dictJson: {
        try {
            ...
            console.log("YDictTypeDetailDtChPoemDataTranslation.qml === dictJson parse error: ", e)
        }
        return new Object
    }
            ...
            YLoader {
                ...
                sourceComponent: {
                    ...
                    case YTranslateText.translation:
                        return id_poem_translation
                    }
                }
                //查看译文
                Component{
                    id:id_poem_translation
                    YDictTypeDtChPoemDataTranslation{
