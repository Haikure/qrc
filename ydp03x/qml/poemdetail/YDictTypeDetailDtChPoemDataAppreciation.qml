...
YBackButtonPage {
    ...
    objectName: "YPage===YDictTypeDetailDtChPoemDataAppreciation.qml"
        ...
        Column {
            ...
            YLoader {
                ...
                active: YEnum.DtChLarge === dictType
                        ...
                        || YEnum.DtChPoemDict+52 === dictType
                //英文词典
                ...
                sourceComponent: {
                        if(content.length) {
                            return id_poem_appreciation
                        }
                 }
                //查看赏析
                Component{
                    id:id_poem_appreciation

                    YDictTypeDtChPoemDataAppreciation{
                        width: {
                            id_dict_content_column.width
                        }
                    }
                }
            }
