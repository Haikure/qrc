...
YBackButtonPage {
    ...
    objectName: "YPage===YDictTypeDetailDtChPoemDataAboutTheAuthor.qml"
    ...
    property var dictJson: {
        try {
            ...
            console.log("YDictTypeDetailDtChPoemDataAboutTheAuthor.qml === dictJson parse error: ", e)
        }
        return new Object
    }
        ...
        Column {
            ...
            YLoader {
                ...
                active: YEnum.DtChLarge === dictType
                        ...
                        || YEnum.DtChPoemDict+53 === dictType
                        //英文词典
                ...
                sourceComponent: {
                  if(content.length)
                        return id_poem_aboutTheAuthor
                }
                //关于作者
                Component{
                    id:id_poem_aboutTheAuthor
                    YDictTypeDtChPoemDataAboutAuthor{
